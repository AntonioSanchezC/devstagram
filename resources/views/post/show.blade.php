...
@section('contenido')
    <div class="container mx-auto md:flex">
        <div class="md:w-1/2">
            ...
            {{-- Oculto a quien ni este autenticado --}}
            @auth
        ...
        <div class="md:w-1/2">
            <div class="shadow bg-white p-5 mb-5">
                ...
                {{-- Vamos a forzar que solo actuen los usuarios autenticados con auth y endauth --}}
                @auth
                    <p class="text-xl font-bold text-center mb-4"></p>
